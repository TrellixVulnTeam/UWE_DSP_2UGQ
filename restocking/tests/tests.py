...
from restocking.models import Product, RestockingList, RestockingListItem
...
class CreatingProductsTestCase(TestCase):
    ...
    def test_create_valid_product(self):
        ...
        self.size = Product.Size.SIZE_4_5
        self.colour = "Red"
        self.price = 47.00
        self.product_type = Product.ProductType.SHOE
        self.product_code = "A"
        self.department = Product.Department.LADIES
...
class NfcTests(TestCase):
    '''
    Tests regarding NFC devices.
    '''
